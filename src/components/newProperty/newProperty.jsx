          ...
          <ContactInfo>
            ...
            <AmenitiesBlog>
              <div className="blog">
                ...
                <BlockCheck>
                  <input type="checkbox" name="barbeque" className="checkbox" />
                ...
                <BlockCheck>
                  <input type="checkbox" name="laundry" className="checkbox" />
              ...
              <div className="blog">
                ...
                <BlockCheck>
                  <input type="checkbox" name="outdoor" className="checkbox" />
              ...
              <div className="blog">
                ...
                <BlockCheck>
                  <input type="checkbox" name="parking" className="checkbox" />
                  <Label name="parking">Parking</Label>
                </BlockCheck>
                <BlockCheck>
                  <input type="checkbox" name="doorman" className="checkbox" />
                  <Label name="doorman">Doorman</Label>
                </BlockCheck>
                <BlockCheck>
                  <input type="checkbox" name="heating" className="checkbox" />
                  <Label name="heating">Central Heating</Label>
                </BlockCheck>
                <BlockCheck>
                  <input type="checkbox" name="service" className="checkbox" />
